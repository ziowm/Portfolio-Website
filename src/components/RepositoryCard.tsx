        ...
        <div className="flex items-center justify-between text-sm text-gray-500 dark:text-gray-400">
          ...
          <div className="flex items-center gap-2">
            {repository.language && (
              <span className="flex items-center gap-1">
                ...
                <span className="text-xs sm:text-sm">{repository.language}</span>
              </span>
            )}
          </div>
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <span className="flex items-center gap-1">
              ...
              <span className="text-xs sm:text-sm">{repository.stargazersCount}</span>
            </span>

            {/* Forks */}
            <span className="flex items-center gap-1">
              <FaCodeBranch className="text-gray-500 w-3 h-3 sm:w-4 sm:h-4" />
              <span className="text-xs sm:text-sm">{repository.forksCount}</span>
            </span>
          </div>
        </div>
      </div>
